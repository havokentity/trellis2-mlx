...
class Trellis2ImageTo3DResult:
    ...
    active_coords: mx.array  # [L_fine, 3] fine-grid voxel coords (for material baking later)
    ...
    * SC-VAE shape dec  ~ 474 M
    ...
    def run(
        ...
        *,
        ...
        print("  [5/5] SC-VAE shape decoder + mesh extraction ...", flush=True, file=sys.stderr)
    ...
    def export_glb(self, result: Trellis2ImageTo3DResult, out_path: str | Path) -> Path:
        """Write the result mesh to a GLB file. Convenience wrapper around
        :func:`trellis2_mlx.ovoxel.postprocess.export_glb`."""
        return export_glb(result.vertices, result.faces, out_path)
