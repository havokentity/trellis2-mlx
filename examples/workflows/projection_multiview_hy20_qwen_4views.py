"""Mirror of upstream ``Projection_MultiView_Hy2.0_Qwen_4Views.json``.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        prog='projection_multiview_hy20_qwen_4views', description=__doc__,
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    add_common_args(parser, 'Projection_MultiView_Hy20_Qwen_4Views.glb')
    parser.add_argument('--views', type=int, default=4, help='Number of views')
    return not_implemented_stub(
        parser, workflow_json='Projection_MultiView_Hy2.0_Qwen_4Views.json',
        missing_features=['MultiViewTexturing pipeline', 'Hunyuan3D + Qwen 4-view'],
